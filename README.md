...
Wise Labs 是一个面向 AI 时代开发者的工作台。它包含多个独立但互补的工具，覆盖终端管理和内容组件复用等场景。
...
│            窗口管理            │            组件图册             │
├──────────────────────────────┼───────────────────────────────┤
│        ai-workstation        │      html-ppt-components       │
├──────────────────────────────┴───────────────────────────────┤
│                        工具定位                               │
│                  整理窗口 → 复用 PPT 组件                     │
└──────────────────────────────────────────────────────────────┘
...
所有工具都考虑 AI Agent 的使用场景。ai-workstation 支持 Agent 直接调用，html-ppt-components 用于复用 AI 生成 PPT / 文档网页的组件。
